...
export const api = {
  ...
  settings: {
    ...
    addProxy: (body) => post('/api/proxies', body),
    updateProxy: (domain, body) => put(`/api/proxies/${encodeURIComponent(domain)}`, body),
    removeProxy: (domain) => del(`/api/proxies/${encodeURIComponent(domain)}`),
